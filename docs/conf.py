...
latex_documents = [
    (master_doc, "invenio-admin.tex", "invenio-admin Documentation", "CERN", "manual"),
]
...
man_pages = [(master_doc, "invenio-admin", "invenio-admin Documentation", [author], 1)]
